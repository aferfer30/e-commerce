...
const realProducts = [
  // LAPTOPS
  {
    ...
    fullDescription:
      "The 16-inch MacBook Pro with M3 Max is an absolute beast. It features a stunning Liquid Retina XDR display, up to 22 hours of battery life, and unparalleled performance for the most demanding workflows.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The 2024 ROG Zephyrus G14 introduces a stunning CNC-machined aluminum chassis, a gorgeous 3K OLED panel with G-Sync, and an RTX 4070, making it the perfect hybrid for creators and gamers.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Lenovo's legendary ThinkPad X1 Carbon Gen 12 features a new haptic trackpad, an Intel Core Ultra processor with dedicated NPU, and aerospace-grade carbon fiber for extreme durability.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Dell XPS 16 features an invisible haptic trackpad, a zero-lattice keyboard, and a stunning 4K+ OLED touch display wrapped in CNC-machined platinum silver.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The 15-inch MacBook Air with M3 chip offers incredible performance and up to 18 hours of battery life in an impossibly thin fanless design.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Razer Blade 16 features a revolutionary dual-mode mini-LED display (UHD+ 120Hz or FHD+ 240Hz) and desktop-class RTX 4090 performance in a sleek unibody chassis.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "HP's Spectre x360 14 offers a 2.8K OLED display, IMAX Enhanced certification, and a gorgeous gem-cut design with incredible battery life.",
    specs: {
      Processor: "Intel Core Ultra 7 155H",
  ...
  },
  {
    ...
    fullDescription:
      "A versatile laptop with a dynamic woven hinge, the Surface Laptop Studio 2 transitions seamlessly from a laptop to an angled stage to a creative canvas.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The LG Gram 17 delivers a massive 17-inch display and phenomenal battery life in a magnesium-alloy body that weighs less than most 13-inch laptops.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Alienware m18 R2 is an unapologetic desktop replacement, featuring advanced Cryo-tech cooling, CherryMX ultra-low profile mechanical keys, and max-TGP graphics.",
    specs: {
      Processor: "Intel Core i9-14900HX",
  ...
  // AUDIO
  {
    ...
    fullDescription:
      "AirPods Pro feature up to 2x more Active Noise Cancellation, Adaptive Transparency, and Personalized Spatial Audio. Now with USB-C and lossless audio support with Vision Pro.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Sony WH-1000XM5 headphones rewrite the rules for distraction-free listening with two processors controlling eight microphones for unprecedented noise cancellation.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Bose QC Ultra headphones feature breakthrough spatial audio for deeper immersion and CustomTune technology that auto-adjusts sound performance to your ears' liking.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Momentum 4 delivers Sennheiser's Signature Sound, next-generation Adaptive ANC, and an extraordinary 60-hour battery life.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Devialet Gemini II true wireless earbuds feature Devialet Adaptive Noise Cancellation™, exceptional acoustic architecture, and a wildly compact design.",
    specs: {
      Drivers: "Custom 10mm Titanium coating",
      "Noise Cancellation":
        "Devialet Adaptive Noise Cancellation™ (Up to 40dB)",
  ...
  },
  {
    ...
    fullDescription:
      "AirPods Max perfectly combine high-fidelity audio with industry-leading Active Noise Cancellation to deliver an unparalleled listening experience. Designed with an acoustic seal for many different head shapes.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Sony's WF-1000XM5 earbuds feature cutting-edge technology to deliver premium sound quality and the best noise-cancelling performance on the market in a compact design.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Beats Studio Pro delivers rich, immersive sound whether you’re listening via Bluetooth or USB-C. Fully custom acoustic platform for zero distortion.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Pi7 S2 continues the Bowers & Wilkins legacy of audio excellence with a 24-bit connection between earbuds, Dual Hybrid Drive units, and a smart charging case that acts as an audio retransmitter.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Samsung's Galaxy Buds2 Pro feature a seamless, ergonomic design, 24-bit Hi-Fi audio, and Intelligent Active Noise Cancellation that tunes out the world.",
    specs: {
  ...
  // ACCESSORIES
  {
    ...
    fullDescription:
      "The Logitech MX Master 3S is an iconic mouse remastered for ultimate tactility, performance, and flow. Features quiet clicks and an 8,000 DPI track-on-glass sensor.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Q1 Pro is a premium full-metal QMK/VIA wireless custom mechanical keyboard. With a 75% layout, it allows anyone to master any keyboard keys or macro commands.",
    specs: {
      Layout: "75% (81 Keys)",
  ...
  },
  {
    ...
    fullDescription:
      "The first 32-inch Retina 6K display ever. Up to 1600 nits of brightness. An astonishing 1,000,000:1 contrast ratio and superwide viewing angle.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The TS4 offers an astounding 18 ports of connectivity, up to 98W of power delivery, and full Thunderbolt 4 40Gb/s performance for modern Mac and PC workflows.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Aeron chair revolutionized office seating with its defining design characteristics. It features 8Z Pellicle suspension material and PostureFit SL back support.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Step up to the world’s most technologically advanced webcam. Logitech Brio delivers 4K Ultra HD video with HDR and RightLight 3 technology.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Magic Keyboard is now available with Touch ID, providing fast, easy, and secure authentication for logins and purchases on your Mac.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "Stream Deck MK.2 features 15 customizable LCD keys to control apps and tools. Trigger actions, launch social posts, adjust audio, play sound clips, and much more.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The Secretlab TITAN Evo brings together the best of the TITAN and OMEGA series. Featuring 4-way L-ADAPT lumbar support and a magnetic memory foam head pillow.",
    specs: {
  ...
  },
  {
    ...
    fullDescription:
      "The LG UltraFine 5K Display provides a breathtaking 5120-by-2880 resolution, P3 wide color gamut, and 94W of power delivery via a single Thunderbolt 3 cable.",
    specs: {
  ...
  for (let i = 0; i < realProducts.length; i++) {
    ...
    if (!categoryId) {
      const newCat = await prisma.category.create({
        data: {
          name:
            p.categorySlug.charAt(0).toUpperCase() + p.categorySlug.slice(1),
          slug: p.categorySlug,
        },
      });
