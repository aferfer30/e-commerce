...
const demoProducts = [
  ...
  },
  {
    ...
    price: 450000,
    categorySlug: "laptops",
    img: "https://images.unsplash.com/photo-1587614382346-4ec70e388b28?auto=format&fit=crop&q=80&w=800",
  },
  {
    name: "LG Gram 17",
    brand: "LG",
  ...
  // Audio
  {
    ...
    price: 45000,
    categorySlug: "audio",
    img: "https://images.unsplash.com/photo-1605464315542-bda3e2f4e605?auto=format&fit=crop&q=80&w=800",
  },
  {
    name: "WH-1000XM5",
    brand: "Sony",
    price: 65000,
    categorySlug: "audio",
    img: "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?auto=format&fit=crop&q=80&w=800",
  },
  {
  ...
  },
  {
    ...
    price: 55000,
    categorySlug: "audio",
    img: "https://images.unsplash.com/photo-1585298723682-7115561c51b7?auto=format&fit=crop&q=80&w=800",
  },
  {
    name: "Jabra Elite 10",
    brand: "Jabra",
  ...
  },
  {
    ...
    price: 45000,
    categorySlug: "accessories",
    img: "https://images.unsplash.com/photo-1595225476474-87563907a212?auto=format&fit=crop&q=80&w=800",
  },
  {
    name: "Magic Keyboard",
    brand: "Apple",
    price: 28000,
    categorySlug: "accessories",
    img: "https://images.unsplash.com/photo-1587826227038-0387b9ce052c?auto=format&fit=crop&q=80&w=800",
  },
  {
    ...
    price: 85000,
    categorySlug: "accessories",
    img: "https://images.unsplash.com/photo-1621361365424-06f0e1eb5c49?auto=format&fit=crop&q=80&w=800",
  },
  {
    ...
    price: 950000,
    categorySlug: "accessories",
    img: "https://images.unsplash.com/photo-1527443154391-507e9dc6c5cc?auto=format&fit=crop&q=80&w=800",
  },
  {
  ...
  },
  {
    ...
    price: 120000,
    categorySlug: "accessories",
    img: "https://images.unsplash.com/photo-1505843490538-5133c6c7d0e1?auto=format&fit=crop&q=80&w=800",
  },
  {
  ...
  for (let i = 0; i < demoProducts.length; i++) {
    ...
    await prisma.product.create({
      data: {
        ...
        images: {
          create: [{ url: p.img, isPrimary: true, order: 0 }],
        },
        inventory: {
          create: {
