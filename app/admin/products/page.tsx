  ...
  return (
    <>
      <SeoHead
        ...
        description="Manage your store's inventory."
      />
            ...
            {products.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-24 gap-4">
                ...
                <p className="text-muted-foreground text-sm max-w-[300px] text-center">
                  Add your first product to start curating your inventory.
                </p>
                <Link
                  href="/admin/products/new"
                  className={buttonVariants({
                  ...
                  {products.map((product) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="py-4">
                          <span
                            className={`text-[10px] uppercase tracking-wider font-bold px-2.5 py-1 rounded-full ${stockStatus.cls}`}
                          >
                            {stockStatus.label}
                          </span>
                        </TableCell>
