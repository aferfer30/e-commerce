...
export default function AdminAnalyticsPage() {
  return (
    <>
      <SeoHead
        title="Analytics"
        description="Analytics dashboard for NovaTech admin panel."
      />
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2 relative overflow-hidden bg-card border border-border/50 rounded-xl p-8">
            ...
            <div className="relative z-10 flex items-center justify-between mb-8">
              ...
              <span className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground bg-muted/40 px-2.5 py-1 rounded border border-border/50">
                This week
              </span>
            </div>
          ...
          <div className="relative overflow-hidden bg-card border border-border/50 rounded-xl p-8">
            <div className="absolute inset-0 bg-noise opacity-[0.02] pointer-events-none" />
            <h2 className="relative z-10 font-display text-base font-bold text-foreground mb-8">
              Top Metrics
            </h2>
