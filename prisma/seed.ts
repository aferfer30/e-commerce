  ...
  for (let i = 0; i < count; i++) {
    ...
    products.push({
      ...
      specifications: JSON.stringify({
        ...
        BatteryLife: randomChoice([
          "24 Hours",
          "30 Hours",
          "40 Hours",
          "12 Hours (Earbuds)",
        ]),
        NoiseCancelling: randomChoice([
          "Yes, ANC",
...
async function main() {
  ...
  const catLaptops = await prisma.category.upsert({
    ...
    create: {
      ...
      slug: "laptops",
      description:
        "High-performance laptops for gaming, creation, and productivity.",
    },
  });
  ...
  const catAccessories = await prisma.category.upsert({
    ...
    create: {
      ...
      slug: "accessories",
      description:
        "Keyboards, mice, and desk accessories to complete your setup.",
    },
  });
